#!/bin/bash
# BIT RAGE LABOUR PowerShell Installation Script
# Installs PowerShell on macOS using Homebrew
# Run with: bash powershell_install.sh

echo "🔧 BIT RAGE LABOUR PowerShell Installation Script"
echo "=============================================="
echo ""
...
if command -v pwsh &> /dev/null; then
    ...
    pwsh -Command "Write-Host 'Hello from PowerShell in BIT RAGE LABOUR!' -ForegroundColor Green; \$PSVersionTable.PSVersion"

    echo ""
    echo "📚 PowerShell is ready for BIT RAGE LABOUR operations!"
    echo ""
    ...
    echo ""
    echo "🎯 Next steps:"
    echo "   - Configure PowerShell profile for BIT RAGE LABOUR"
    echo "   - Set up PowerShell modules for automation"
    echo "   - Integrate with existing BIT RAGE LABOUR scripts"
...
echo ""
echo "🎉 Installation complete! Welcome to PowerShell on BIT RAGE LABOUR."
