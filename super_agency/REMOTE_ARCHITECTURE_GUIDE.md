# 🚀 BIT RAGE LABOUR Remote Architecture Setup
...
New-NetFirewallRule -DisplayName "BIT RAGE LABOUR Remote" -Direction Inbound -Protocol TCP -LocalPort 5985,8081 -Action Allow
```
...
```powershell
# On Windows (in BIT RAGE LABOUR directory)
...
### SASP Protocol (BIT RAGE LABOUR Share Protocol)
