...
- [x] Wire memory system into agent startup (memory backup thread in run_digital_labour.py)
...
- [x] Centralized log file with rotation (RotatingFileHandler, 5MB x 5 backups, logs/digital_labour.log)
