...
$Script = "$WorkspacePath\run_digital_labour.py"
...
Write-Log "[LAUNCHER] Digital Labour startup initiated"
...
if (-not (Test-Path $Script)) {
    Write-Log "[LAUNCHER] FATAL: run_digital_labour.py not found"
    exit 1
}
...
Write-Log "[LAUNCHER] Starting run_digital_labour.py ..."
