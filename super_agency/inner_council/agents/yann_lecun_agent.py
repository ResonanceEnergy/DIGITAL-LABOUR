    ...
    def __init__(self):
        ...
        self.topic_patterns = {
            ...
            ['artificial intelligence', 'machine learning', 'neural',
             'deep learning'],
            'machine learning':
            ['machine learning', 'machine learning related'],
            'computer vision': ['computer vision', 'computer vision related'],
            'neuroscience': ['neuroscience', 'neuroscience related']}

        logger.info(
            "Yann LeCun Agent initialized with specialized ai, machine learning, computer vision, neuroscience focus")
