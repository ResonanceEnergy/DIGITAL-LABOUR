...
class CandaceOwensAgent(BaseCouncilAgent):
    ...
    def __init__(self):
        ...
        self.topic_patterns = {
            ...
            'social issues': ['social issues', 'social issues related']}

        logger.info(
            "Candace Owens Agent initialized with specialized politics, culture, current events, social issues focus")
