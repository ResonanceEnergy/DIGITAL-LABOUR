...
class ShaneParrishAgent(BaseCouncilAgent):
    ...
    def __init__(self):
        super().__init__(
            ...
            focus_areas=['Decision Making',
                'Psychology', 'Learning', 'Business'],
            priority="medium",
        ...
        self.topic_patterns = {
            'decision making': ['decision making', 'decision making related'],
        ...
        logger.info(
            "Shane Parrish Agent initialized with specialized decision making, psychology, learning, business focus")
