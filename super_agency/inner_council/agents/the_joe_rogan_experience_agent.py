...
class TheJoeRoganExperienceAgent(BaseCouncilAgent):
    ...
    def __init__(self):
        ...
        self.topic_patterns = {
            ...
            'entertainment': ['entertainment', 'entertainment related']}

        logger.info(
            "The Joe Rogan Experience Agent initialized with specialized culture, science, politics, health, entertainment focus")
    ...
    def _monitor_channel(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            logger.error(
                f"Error monitoring The Joe Rogan Experience channel: {e}")
            return []
    ...
    def _analyze_the_joe_rogan_experience_content(self, video: Dict
