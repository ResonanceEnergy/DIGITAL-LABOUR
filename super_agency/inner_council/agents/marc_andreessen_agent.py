...
class MarcAndreessenAgent(BaseCouncilAgent):
    ...
    def __init__(self):
        ...
        self.topic_patterns = {
            ...
            'venture capital': ['venture capital', 'venture capital related'],
            'ai':
            ['artificial intelligence', 'machine learning', 'neural',
             'deep learning'],
            'software': ['software', 'software related']}

        logger.info(
            "Marc Andreessen Agent initialized with specialized technology, venture capital, ai, software focus")
