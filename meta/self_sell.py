"""Meta Sales Ops — BIT RAGE SYSTEMS selling itself using its own Sales Ops agent.

This module automates cold outreach for BIT RAGE SYSTEMS's own services.
...
PRODUCT_DESCRIPTIONS = {
    "sales_outreach": (
        "BIT RAGE SYSTEMS runs an AI agent that researches a target company, "
    ...
    "support_ticket": (
        "BIT RAGE SYSTEMS runs an AI agent that triages inbound support tickets, "
    ...
    "content_repurpose": (
        "BIT RAGE SYSTEMS runs an AI agent that takes a single piece of content "
    ...
    "full_suite": (
        "BIT RAGE SYSTEMS provides an AI workforce that handles sales outreach, "
