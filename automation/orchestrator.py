"""Master Orchestrator — single command to run the full BIT RAGE SYSTEMS operation.
...
def launch_all_services():
    ...
    logger.info(f"\n{'='*60}")
    logger.info("  LAUNCHING BIT RAGE SYSTEMS SERVICES")
    logger.info(f"{'='*60}")
...
def show_full_status():
    ...
    logger.info(f"\n{'='*60}")
    logger.info("  BIT RAGE SYSTEMS — OPERATIONAL STATUS")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="BIT RAGE SYSTEMS — Master Orchestrator",
