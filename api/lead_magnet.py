...
<title>Bit Rage Labour — Free Demo</title>
<style>
...
async def run_demo(req: DemoRequest):
    ...
    try:
        ...
        output = call_llm(
            system_prompt=f"You are a professional {service['label']} writer for BIT RAGE LABOUR agency. "
    ...
    try:
        ...
        send_email(
            to=req.email,
            subject=f"Your Free {service['label']} — Bit Rage Labour",
...
<p style="color:#888;font-size:12px">Bit Rage Labour — AI Workforce on Demand<br>
