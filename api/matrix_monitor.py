"""BIT RAGE SYSTEMS MATRIX MONITOR — Command & Control API.
...
def test_alert(_auth=Depends(verify_matrix_auth)):
    ...
    result = _send_telegram_alert("🧪 BIT RAGE SYSTEMS MATRIX TEST — Notifications are working!")
    return result
